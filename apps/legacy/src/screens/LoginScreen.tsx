...
import { friendlyAuthErrorMessage } from '@fleet/shared-auth';
import { loadSavedCredentials, saveCredentials } from '@fleet/shared-auth';
...
import { userRoleLabel } from '@fleet/shared-auth';
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={styles.flex}>
        <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
          <View style={styles.deprecationBanner}>
            <Text style={styles.deprecationTitle}>App monolito deprecada</Text>
            <Text style={styles.deprecationText}>
              Instala Fleet Control Campo (worker) o Fleet Control Admin. Este build se retirara pronto.
            </Text>
          </View>
